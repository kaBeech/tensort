...
import Data.Robustsort.Comparison.Mergesort qualified (mergesort)
import Data.Robustsort.Comparison.Quicksort qualified (quicksort)
...
main = do
  ...
  putStrLn ("mergesort: " ++ show (Data.Robustsort.Comparison.Mergesort.mergesort unsortedArray))
  putStrLn ("quicksort: " ++ show (Data.Robustsort.Comparison.Quicksort.quicksort unsortedArray))
